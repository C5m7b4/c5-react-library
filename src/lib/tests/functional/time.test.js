...
import {
  ...
  nextMinute,
  getTime
} from "../../DatePicker/time";

describe("time.js", () => {
  describe("nextYear", () => {
    it("should return correct parameter", function() {
      expect(() => nextYear(undefined, -1)).to.throw("Invalid Date");
      expect(() => nextYear(4345345)).to.throw("Invalid Date");
    });
  ...
  describe("nextMonth", () => {
    it("should return correct parameter", function() {
      expect(() => nextMonth(undefined, -1)).to.throw("Invalid Date");
      expect(() => nextMonth(4345345)).to.throw("Invalid Date");
    });
  ...
  describe("nextDate", () => {
    it("should return correct parameter", function() {
      expect(() => nextDate(undefined, -1)).to.throw("Invalid Date");
      expect(() => nextDate(4345345)).to.throw("Invalid Date");
    });
  ...
  describe("nextHour", () => {
    it("should return correct parameter", function() {
      expect(() => nextHour(undefined, -1)).to.throw("Invalid Date");
      expect(() => nextHour(4345345)).to.throw("Invalid Date");
    });
  ...
  describe("nextMinute", () => {
    it("should return correct parameter", function() {
      expect(() => nextMinute(undefined, -1)).to.throw("Invalid Date");
      expect(() => nextMinute(4345345)).to.throw("Invalid Date");
    });
